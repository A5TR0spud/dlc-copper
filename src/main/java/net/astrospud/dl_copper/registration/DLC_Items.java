...
public class DLC_Items {
    ...
    public static void init() {
        ...
        BATTERY_PACK = registerItem(new BatteryPackItem(new FabricItemSettings().group(ItemGroup.TOOLS).maxDamage(256)), "battery_pack");
        EMPTY_MODULE = registerItem(new Item(new FabricItemSettings().group(ItemGroup.MATERIALS)), "empty_module");
        FLAMEWAKER_MODULE_BOOTS = registerItem(new FlamewakerModuleItem(new FabricItemSettings().group(ItemGroup.TOOLS)), "flamewaker_module_boots");
